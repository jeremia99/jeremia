            ...
            <nav class="navbar navbar-inverse" role="navigation">
                ...
                <div id="main-nav" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav" id="mainNav">
                        ...
                        ?>
                        <li><a href="login.php" class="scroll-link">Masuk</a></li>
                        <?php
                            }
                        ?>                        
                    </ul>
        ...
        <div class="banner-container">
            ...
            <div class="container banner-content">
                <div id="da-slider" class="da-slider">
                    <div class="da-slide">
                        <h2>Developed</h2>
                        <p>Ari Munandar | Distributed BlogBugaBagi</p>
                        <div class="da-img"></div>
                    </div>
                    <div class="da-slide">
                        <h2>Sistem Informasi Management Nilai Siswa</h2>
                        <p>SMP Negeri 14 Padang</p>
                        <div class="da-img"></div>
                    </div>
                    <nav class="da-arrows">
    ...
    <section id="profile" class="page-section" style="background:#222222;">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    <p>        
                        <label style="padding-right:70px;">Sekolah</label> : SMP Negeri 14 Padang <br>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 text-right">
                    Distributed By | <a target="_blank" href="https://blogbugabagi.blogspot.com">BlogBugaBagi</a>        
                </div>
            </div>
            <!-- / .row -->
        </div>
