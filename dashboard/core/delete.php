...
<?php 
	...
	if (isset($_GET['pelajaran-del'])) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM pelajaran WHERE pelajaran_id = $id");
		if ($delete) {
...
<?php 
	...
	if (isset($_GET['sekolah-del'])) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM sekolah WHERE sekolah_id = $id");
		if ($delete) {
...
<?php 
	...
	if (isset($_GET['artikel-del'])) {
		...
		$delete 	=	mysqli_query($koneksi,"DELETE FROM artikel WHERE artikel_id = $id");
		if ($delete) {
