<?php 
	...
	if (isset($_POST['create-admin'])) {
		...
		$admin 		= 	mysqli_query($koneksi,"INSERT INTO users (`id`, `nomor_induk`, `name`, `username`, `password`, `telp`, `alamat`, `status`, `jenis_kelamin`, `kelas_id`, `access`) 
...
<?php 
	...
	if (isset($_POST['create-guru'])) {
		...
		$guru 		= 	mysqli_query($koneksi,"INSERT INTO users (`id`, `nomor_induk`, `name`, `username`, `password`, `telp`, `alamat`, `status`, `jenis_kelamin`, `kelas_id`, `access`) 
...
<?php 
	...
	if (isset($_POST['create-siswa'])) {
		...
		$name 		= 	mysqli_query($koneksi,"INSERT INTO users (`id`, `nomor_induk`, `name`, `username`, `password`, `telp`, `alamat`, `status`, `jenis_kelamin`, `kelas_id`, `access`) 
...
<?php 
	...
	if (isset($_POST['create-kelas'])) {
		...
		$kelas 		= 	mysqli_query($koneksi,"INSERT INTO kelas (`kelas_id`, `kelas_nama`) 
...
<?php 
	...
	if (isset($_POST['create-tahun'])) {
		...
		$tahun 		= 	mysqli_query($koneksi,"INSERT INTO tahun (`tahun_id`, `tahun_nama`) 
...
<?php 
	...
	if (isset($_POST['create-pelajaran'])) {
		...
		$pelajaran 		= 	mysqli_query($koneksi,"INSERT INTO pelajaran (`pelajaran_id`, `pelajaran_nama`) 
...
<?php 
	...
	if (isset($_POST['create-kategori'])) {
		...
		$kategori 			= 	mysqli_query($koneksi,"INSERT INTO kategori (`kategori_id`, `kategori_nama`, `kategori_deskripsi`) 
...
<?php 
	...
	if (isset($_POST['create-sekolah'])) {
		...
		$sekolah 			= 	mysqli_query($koneksi,"INSERT INTO sekolah (`sekolah_id`, `sekolah_nama`, `sekolah_alamat`, `sekolah_telp`, `sekolah_visi`, `sekolah_misi`) 
...
<?php 
	if (isset($_POST['input-proses'])) {
		...
		for($x=0;$x<$jumlahdata;$x++) {
			$nilai	=	mysqli_query($koneksi,"INSERT INTO nilai (`nilai_id`, `id`, `pelajaran_id`, `semester_id`, `tahun_id`,`nilai_kkm`, `nilai_poin`) 
	...
	if(isset($_POST['upload'])){
        ...
        if(in_array($file_ext, $allowed_ext) === true){
            if($file_size < 20440700){
                ...
                $in = mysqli_query($koneksi,"INSERT INTO download VALUES(NULL, '$tgl', '$nama', '$file_ext', '$file_size', '$lokasi')");
                if($in){
...
<?php 
	...
	if (isset($_POST['create-artikel'])) {
		...
		$artikel 	=	mysqli_query($koneksi,"INSERT INTO artikel (`artikel_id`, `artikel_judul`, `artikel_isi`, `artikel_tgl`, `kategori_id`) 
