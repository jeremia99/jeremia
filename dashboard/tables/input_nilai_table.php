                                        ...
                                        <table width="100%">
                                            <tr>
                                                <?php
                                                    ...
                                                    $sql  =   mysqli_query($koneksi,"SELECT * FROM pelajaran WHERE pelajaran_id=$pelajaran");
                                        ...
                                        <form role="form" method="post">
                                            <?php
                                                ...
                                                if(isset($_POST['input-nilai'])) {
                                                    ...
                                                    $access     =   'siswa'; 
                                                    $kkm        =   $_POST['kkm'];
                                                    $sql = mysqli_query($koneksi,"SELECT users.id, users.name, users.access, kelas.kelas_id, kelas.kelas_nama 
                                                                        FROM users
